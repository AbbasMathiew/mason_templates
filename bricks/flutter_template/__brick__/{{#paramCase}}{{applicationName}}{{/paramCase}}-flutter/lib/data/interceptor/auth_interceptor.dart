...
import 'package:{{#snakeCase}}{{applicationName}}{{/snakeCase}}/data/interceptor/meta_interceptor.dart';
import 'package:{{#snakeCase}}{{applicationName}}{{/snakeCase}}/data/model/auth/auth_tokens.dart';
...
import 'package:{{#snakeCase}}{{applicationName}}{{/snakeCase}}/data/services/response_errors.dart';
import 'package:{{#snakeCase}}{{applicationName}}{{/snakeCase}}/data/services/response_objects/tokens_response.dart';
